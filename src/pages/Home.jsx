...
const [typeEffect] = useTypewriter({
  ...
  <div className='container  mx-auto  flex justify-center flex-col sm:flex-row'>
           <div className='md:w-1/2  text-center md:text-left'>
            <h2 className=' text-white text-3xl  font-bold mt-24 '>Hello, I'm <span className="gradient-text text-4xl font-bold">
            pughazhendhi</span> </h2>
            <p className='text-3xl text-white mt-3'>and i am a Passionate</p>
          <div className="mt-2"><span className='font-bold gradient-text text-4xl'>{typeEffect}</span> <span className="bg-white"><Cursor /></span></div>
          <div className='mt-7'>
